...
tasks.configureEach<JavaCommentPreprocessorTask> {
    ...
    variables.apply {
        put("mvn.project.property.postgresql.jdbc.spec", "JDBC4.1")
        put("mvn.project.property.jdbc.specification.version", "4.1")
        put("mvn.project.property.jdbc.specification.version.nodot", "41")
        // TODD: remove parsedversion.*?
        put("mvn.project.property.parsedversion.osgiversion", "42.3.0")
        put("mvn.project.property.parsedversion.majorversion", "42")
        put("mvn.project.property.parsedversion.minorversion", "3")
        put("mvn.project.property.parsedversion.incrementalversion", "0")
        put("mvn.project.property.template.default.pg.port", "5432")
    }
}
