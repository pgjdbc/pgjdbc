...
public abstract class AbstractJdbc2ResultSet implements BaseResultSet, org.postgresql.PGRefCursorResultSet
{
    ...
    throws SQLException
    {
        ...
        else
        {
            ...
            if ( usingOID )
            {
                ...
                updateValues.put("oid", Long.valueOf(insertedOID) );
    ...
    private int findColumnIndex(String columnName)
    {
        if (columnNameIndexMap == null)
        {
            ...
            {
                columnNameIndexMap.put(fields[i].getColumnLabel().toLowerCase(Locale.US), Integer.valueOf(i + 1));
            }
        }
    ...
    protected void checkColumnIndex(int column) throws SQLException
    {
        if ( column < 1 || column > fields.length )
            throw new PSQLException(GT.tr("The column index is out of range: {0}, number of columns: {1}.", new Object[]{Integer.valueOf(column), Integer.valueOf(fields.length)}), PSQLState.INVALID_PARAMETER_VALUE );
    }
