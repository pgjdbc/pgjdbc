 ...
 */
public class PooledFullXADataSourceTest extends TestCase {

    private PGFullXADataSource ds;
    private List<XAConnection> pool;
    
    private static AtomicInteger xidCounter = new AtomicInteger(0);

    public PooledFullXADataSourceTest(final String name) {
        super(name);
        ds = new PGFullXADataSource();
