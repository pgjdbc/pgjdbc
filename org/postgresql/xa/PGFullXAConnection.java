 ...
 */
public class PGFullXAConnection extends PGPooledConnection implements XAConnection, XAResource {

    private String user;
    private String password;
    private PGFullXADataSource dataSource;
    
    private PhysicalFullXAConnection backend;
    private boolean closeHandleInProgress;
    
    protected PGFullXAConnection(final String user, final String password, final Connection logicalConnection, PGFullXADataSource dataSource) {
     ...
     */
    PhysicalFullXAConnection getPhysicalXAConnection() {
        return backend;
    }
     ...
     * Managed by the PhysicalXAConnection's associate / disassociate methods.
     */
    void setPhysicalXAConnection(PhysicalFullXAConnection backend) {
