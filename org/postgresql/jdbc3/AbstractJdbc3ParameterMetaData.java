...
public abstract class AbstractJdbc3ParameterMetaData {
    ...
    private void checkParamIndex(int param) throws PSQLException {
        if (param < 1 || param > _oids.length)
            throw new PSQLException(GT.tr("The parameter index is out of range: {0}, number of parameters: {1}.", new Object[]{Integer.valueOf(param), Integer.valueOf(_oids.length)}), PSQLState.INVALID_PARAMETER_VALUE);
    }
