...
public class DatabaseMetaDataPropertiesTest extends TestCase
{
    ...
    public void testDriverVersioning() throws SQLException
    {
        ...
        assertTrue(dbmd.getDriverVersion().equals(Driver.getVersion()));
        assertTrue(dbmd.getDriverMajorVersion() == Driver.MAJORVERSION);
        assertTrue(dbmd.getDriverMinorVersion() == Driver.MINORVERSION);
    }
}
