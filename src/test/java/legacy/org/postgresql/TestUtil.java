...
public class TestUtil
{
    ...
    {
        return "localhost"; // Value copied from the ANT build file.
    }
    ...
    {
        return 5455; // Value copied from the ANT build file.
    }
    ...
    {
        return 5; // Value copied from the ANT build file.
    }

    public static int getProtocolVersion()
    {
        return 0; // Value copied from the ANT build file.
    }
    ...
    {
        return "test"; // Value copied from the ANT build file.
    }
    ...
    {
        return "password"; // Value copied from the ANT build file.
    }
    ...
    public static void initDriver() throws Exception
    {
        synchronized (TestUtil.class) {
            ...
            Driver.setLogLevel(getLogLevel()); // Also loads and registers driver.
            initialized = true;
        }
    }        
    ...
    public static String escapeString(Connection con, String value) throws SQLException
    {
        ...
        {
            return ((AbstractJdbc2Connection)con).escapeString(value);
        }
        return value;
    }
    ...
    public static boolean getStandardConformingStrings(Connection con)
    {
        if (con instanceof AbstractJdbc2Connection)
        {
            return ((AbstractJdbc2Connection)con).getStandardConformingStrings();
        }
        return false;
    }
    ...
    public static boolean haveMinimumServerVersion(Connection con, String version) throws SQLException {
        if (con instanceof AbstractJdbc2Connection)
        {
            return ((AbstractJdbc2Connection)con).haveMinimumServerVersion(version);
        }
        return false;
    }
