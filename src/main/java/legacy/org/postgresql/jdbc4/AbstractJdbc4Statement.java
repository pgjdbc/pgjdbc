...
import legacy.org.postgresql.jdbc3g.AbstractJdbc3gStatement;
...
abstract class AbstractJdbc4Statement extends AbstractJdbc3gStatement
{
    ...
    {
        throw Driver.notImplemented(this.getClass(), "closeOnCompletion()");
    }

    public boolean isCloseOnCompletion() throws SQLException
    {
        throw Driver.notImplemented(this.getClass(), "isCloseOnCompletion()");
    }
