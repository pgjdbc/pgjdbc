...
public abstract class AbstractJdbc4SQLXML {
    ...
    public AbstractJdbc4SQLXML(BaseConnection conn)
    {
        this(conn, null, false);
    }

    public AbstractJdbc4SQLXML(BaseConnection conn, String data)
    {
        this(conn, data, true);
    }

    private AbstractJdbc4SQLXML(BaseConnection conn, String data, boolean initialized)
    {
        _conn = conn;
        _data = data;
