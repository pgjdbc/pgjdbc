...
dependencies {
    ...
    implementation("com.github.spotbugs:com.github.spotbugs.gradle.plugin:6.0.25")
    ...
    implementation("org.openrewrite.rewrite:org.openrewrite.rewrite.gradle.plugin:6.26.0")
}
