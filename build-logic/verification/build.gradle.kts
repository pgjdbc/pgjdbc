...
dependencies {
    ...
    implementation("com.github.spotbugs:com.github.spotbugs.gradle.plugin:6.0.26")
    ...
    implementation("org.checkerframework:org.checkerframework.gradle.plugin:0.6.47")
    implementation("org.openrewrite.rewrite:org.openrewrite.rewrite.gradle.plugin:6.28.2")
}
