...
dependencies {
    ...
    implementation("com.github.spotbugs:com.github.spotbugs.gradle.plugin:6.1.2")
    ...
    implementation("org.openrewrite.rewrite:org.openrewrite.rewrite.gradle.plugin:6.29.4")
}
