...
dependencies {
    ...
    implementation("com.github.spotbugs:com.github.spotbugs.gradle.plugin:6.0.24")
    ...
    implementation("org.openrewrite.rewrite:org.openrewrite.rewrite.gradle.plugin:6.25.0")
}
