...
### Fixed
* fix: `BlobOutputStream.close()` now releases its buffer, which is up to 512KiB and is never read again, instead of holding it until the stream itself is collected [PR #4373](https://github.com/pgjdbc/pgjdbc/pull/4373)
