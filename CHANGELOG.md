...
### Fixed
* fix: a backend message that ends in the middle of a string now fails with a message saying so, instead of a bare `EOFException` from `VisibleBufferedInputStream.scanCStringLength` [PR #4380](https://github.com/pgjdbc/pgjdbc/pull/4380)
