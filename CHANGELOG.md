...
Add to TestUtil and also to DatabaseMetaData setup and teardown fixes #2060
...
safety TimestampUtil is not thread safe. It raises exceptions when multiple threads use ResultSets of one connection.
