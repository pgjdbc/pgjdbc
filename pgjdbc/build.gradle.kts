...
dependencies {
    ...
    testFixturesImplementation("org.junit.jupiter:junit-jupiter-api:5.10.4")
    testFixturesImplementation("org.junit.jupiter:junit-jupiter-engine:5.10.4") {
        because("We use BeforeEachMethodAdapter to add parameters to beforeeach and aftereach methods")
    }
    testFixturesImplementation("org.checkerframework:checker-qual:3.48.1")
}
