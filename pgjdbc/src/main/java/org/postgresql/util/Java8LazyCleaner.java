...
/**
 * LegacyLazyCleaner is the Java 8 compatible implementation that uses PhantomReferences
 * and ForkJoinPool for deferred cleanup operations.
 *
 * <p>Note: this is a driver-internal class</p>
 */
class Java8LazyCleaner extends LazyCleaner {
  private static final Logger LOGGER = Logger.getLogger(Java8LazyCleaner.class.getName());
  ...
  Java8LazyCleaner(Duration threadTtl, final String threadName) {
