...
public class messages_ru extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[214] = "Illegal UTF-8 sequence: final value is out of range: {0}";
    t[215] = "Неверная последовательность UTF-8: финальное значение вне области допустимых: {0}";
    ...
    t[378] = "Expected an EOF from server, got: {0}";
    t[379] = "Неожиданный ответ от сервера. Ожидалось окончание потока, получен байт {0}";
