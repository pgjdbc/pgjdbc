...
public class messages_ja extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[176] = "Fetch size must be a value greater than or equal to 0.";
    t[177] = "フェッチサイズは、0または、より大きな値でなくてはなりません。";
    ...
    t[492] = "Error preparing transaction. prepare xid={0}";
    t[493] = "トランザクションの準備エラー。prepare xid={0}";
    ...
    t[928] = "The password callback class provided {0} could not be instantiated.";
    t[929] = "渡されたパスワードコールバッククラス {0} はインスタンス化できませんでした。";
    ...
    t[944] = "Location: File: {0}, Routine: {1}, Line: {2}";
    t[945] = "場所: ファイル: {0}, ルーチン: {1},行: {2}";
    ...
    t[1104] = "Cannot commit when autoCommit is enabled.";
    t[1105] = "autoCommit有効時に、明示的なコミットはできません。";
