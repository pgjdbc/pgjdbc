...
public class messages_ja extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[162] = "{0} function takes three and only three arguments.";
    t[163] = "{0} 関数はちょうど3個の引数を取ります。";
    ...
    t[221] = "{0} 関数は引数を取りません。";
    t[222] = "Could not initialize SSL context.";
    ...
    t[286] = "Fetch size must be a value greater than or equal to 0.";
    t[287] = "フェッチサイズは、0または、より大きな値でなくてはなりません。";
    ...
    t[334] = "The parameter index is out of range: {0}, number of parameters: {1}.";
    t[335] = "パラメータのインデックスが範囲外です: {0} , パラメータ数: {1}";
    ...
    t[370] = "Unsupported properties: {0}";
    t[371] = "サポートされないプロパティ: {0}";
    ...
    t[486] = "Fastpath call {0} - No result was returned or wrong size while expecting an integer.";
    t[487] = "Fastpath 呼び出し {0} - integer を想定していましたが、結果は返却されないかまたは間違った大きさでした。";
    t[490] = "Position: {0}";
    t[491] = "位置: {0}";
    ...
    t[656] = "Unsupported type conversion to {0}.";
    t[657] = "{0} への型変換はサポートされていません。";
    ...
    t[672] = "Properties for the driver contains a non-string value for the key {0}";
    t[673] = "このドライバのプロパティでは以下のキーに対して文字列ではない値が設定されています: {0}";
    ...
    t[886] = "There are no rows in this ResultSet.";
    t[887] = "このResultSetに行がありません。";
    t[888] = "Internal Position: {0}";
    t[889] = "内部位置: {0}";
    t[892] = "CommandComplete expected COPY but got: {0}";
    t[893] = "CommandComplete はCOPYを想定しましたが、次の結果が返却されました: {0}";
