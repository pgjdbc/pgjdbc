 ...
 * {@link #execute(ExecuteOptions)} for single queries and
 * {@link #execute(ExecuteManyOptions)} for batches of queries)
...
public interface QueryExecutor extends TypeTransferModeRegistry {
   ...
   *
   * @param options the query, handler, and other parameters to execute
   * @throws SQLException if query execution fails
   */
  void execute(ExecuteOptions options) throws SQLException;

  /**
   * Execute several Query, passing results to a provided ResultHandler.
   *
   * @param options the queries, parameter lists, handler, and other parameters to execute
   * @throws SQLException if query execution fails
   */
  void execute(ExecuteManyOptions options) throws SQLException;
