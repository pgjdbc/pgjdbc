...
public class PgStatement implements Statement, BaseStatement
{
    ...
    protected ResultHandler createBatchHandler(int[] updateCounts, Query[] queries, ParameterList[] parameterLists)
    {
        return new BatchResultHandler(this, queries, parameterLists, updateCounts, wantsGeneratedKeysAlways);
    }
