...
public class PgDatabaseMetaData implements DatabaseMetaData
{
    ...
    {
        return connection.createStatement(java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY);
    }
    ...
    public ResultSet getFunctionColumns(String catalog, String schemaPattern, String functionNamePattern, String columnNamePattern) throws SQLException {
        return getProcedureColumns(getJDBCMajorVersion(), catalog, schemaPattern, functionNamePattern, columnNamePattern);
    }
