    ...
    private Object buildArray (PgArrayList input, int index, int count) throws SQLException
    {
        ...
        if (type == Types.BIT)
        {
            ...
            for (; count > 0; count--)
            {
                ...
                if (dims > 1 || useObjects)
                {
                    oa[length++] = o == null ? null : (dims > 1 ? buildArray((PgArrayList) o, 0, -1) : PgResultSet.toBoolean((String) o));
                }
                else
                {
        ...
        else if (type == Types.SMALLINT || type == Types.INTEGER)
        {
            ...
            for (; count > 0; count--)
            {
                ...
                if (dims > 1 || useObjects)
                {
                    oa[length++] = o == null ? null : (dims > 1 ? buildArray((PgArrayList) o, 0, -1) : PgResultSet.toInt((String) o));
                }
                else
                {
        ...
        else if (type == Types.BIGINT)
        {
            ...
            for (; count > 0; count--)
            {
                ...
                if (dims > 1 || useObjects)
                {
                    oa[length++] = o == null ? null : (dims > 1 ? buildArray((PgArrayList) o, 0, -1) : PgResultSet.toLong((String) o));
                }
                else
                {
        ...
        else if (type == Types.NUMERIC)
        {
            ...
            for (; count > 0; count--)
            {
                ...
                oa[length++] = dims > 1 && v != null ? buildArray((PgArrayList) v, 0, -1) : (v == null ? null : PgResultSet.toBigDecimal((String) v));
            }
        }
        ...
        else if (type == Types.REAL)
        {
            ...
            for (; count > 0; count--)
            {
                ...
                if (dims > 1 || useObjects)
                {
                    oa[length++] = o == null ? null : (dims > 1 ? buildArray((PgArrayList) o, 0, -1) : PgResultSet.toFloat((String) o));
                }
                else
                {
        ...
        else if (type == Types.DOUBLE)
        {
            ...
            for (; count > 0; count--)
            {
                ...
                if (dims > 1 || useObjects)
                {
                    oa[length++] = o == null ? null : (dims > 1 ? buildArray((PgArrayList) o, 0, -1) : PgResultSet.toDouble((String) o));
                }
                else
                {
