 ...
 */
public class PlatformThreadPipeliningTest extends BaseTest4 {
  ...
  public void testPipelining() throws Exception {
    ...
    // Pipelined should be significantly faster (at least 10% faster)
    assertTrue(pipelinedTime < sequentialTime * 0.9,
