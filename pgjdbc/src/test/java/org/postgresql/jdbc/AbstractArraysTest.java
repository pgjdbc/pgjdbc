...
public abstract class AbstractArraysTest<A> {
  ...
  private static final class EncodingConnection implements BaseConnection {
    ...
    @Override
    public PreparedStatement prepareStatement(String sql, PlaceholderStyle placeholderStyle)
        throws SQLException {
      throw new UnsupportedOperationException();
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys,
        PlaceholderStyle placeholderStyle) throws SQLException {
      throw new UnsupportedOperationException();
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int @Nullable [] columnIndexes,
        PlaceholderStyle placeholderStyle) throws SQLException {
      throw new UnsupportedOperationException();
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String @Nullable [] columnNames,
        PlaceholderStyle placeholderStyle) throws SQLException {
      throw new UnsupportedOperationException();
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType,
        int resultSetConcurrency, PlaceholderStyle placeholderStyle) throws SQLException {
      throw new UnsupportedOperationException();
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType,
        int resultSetConcurrency, int resultSetHoldability, PlaceholderStyle placeholderStyle)
        throws SQLException {
      throw new UnsupportedOperationException();
    }
