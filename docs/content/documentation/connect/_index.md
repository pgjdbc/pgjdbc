...
description: "JDBC URL syntax, timeouts, connection pooling, Unix sockets, multi-host fail-over, and integration with connection pools."
---
...
established connection, production [connection pooling](/documentation/connect/connection-pooling/)
with HikariCP / Tomcat JDBC / c3p0, multi-host fail-over and load
