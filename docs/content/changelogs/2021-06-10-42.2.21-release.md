...
version: 42.2.21
summary: "Backpatches updateable ResultSet requiring primary keys, async notify after ReadyForQuery, OSGi activator rework, and search_path-respecting metadata."
---
