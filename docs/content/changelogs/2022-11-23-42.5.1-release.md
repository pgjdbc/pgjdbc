...
categories:
    - new_release
version: 42.5.1
summary: "Security: StreamWrapper temp-file world-readable on Unix when spilling large setText/setBytea payloads (CVE-2022-41946). Fixes binary bool decoding."
---
