...
version: 42.2.2
summary: "Fixes Blob/Clob mark/reset, reWriteBatchedInserts with ON CONFLICT update, and RETURNING for WITH queries and INSERT/UPDATE/DELETE after comments."
---
