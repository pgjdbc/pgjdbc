...
version: 42.1.2
summary: "Better RETURNING-keyword detection. Batch inserts now use server-prepared statements when prepareThreshold>0. Fixes statusIntervalUpdate high CPU."
---
