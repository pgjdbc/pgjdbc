...
version: 42.2.1
summary: "Packages the SCRAM client classes so shaded jars work. Fixes DateStyle=ISO connect failure (pgbouncer) and reWriteBatchedInserts with ON CONFLICT."
---
