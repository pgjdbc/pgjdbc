...
docs: specify that timeouts are in seconds and there is a maximum. Housekeeping on some tests f`ixes [#Issue 2671](https://github.com/pgjdbc/pgjdbc/issues/2671) [PR #2686](https://github.com/pgjdbc/pgjdbc/pull/2686)\
