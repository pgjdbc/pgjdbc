...
version: 42.4.2
summary: "Fixes GSS regression from Java-17 build changes. setObject accepts UUID arrays. Adds SSL-upgrade response timeout; synchronizes statement execution."
---
