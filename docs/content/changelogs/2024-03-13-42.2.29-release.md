...
categories:
    - new_release
version: 42.2.29
summary: "Fixes ByteBuffer#position NoSuchMethodError on Java 8 (42.2.28 built with Java 17). Also fixes SimpleParameterList type casting for well-known types."
---
**Notable changes**
